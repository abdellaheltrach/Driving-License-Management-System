...
{
    public partial class ctrlDrivingLicenseAplicationInfo : UserControl
    {
        ...
        public ctrlDrivingLicenseAplicationInfo()
        {
            InitializeComponent();
        }
        ...
        {
            _LicenseID = _LocalDrivingLicenseApplication.LocalDrivingLicenseApplicationsID;

            //incase there is license enable the show link.
            llShowLicenceInfo.Enabled = (_LicenseID != -1);


            lblLocalDrivingLicenseApplicationID.Text = _LocalDrivingLicenseApplication.LocalDrivingLicenseApplicationsID.ToString();
